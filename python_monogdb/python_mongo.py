...
client = MongoClient("mongodb+srv://dipeshpatro:5yn8qPTH7oMpZq57@cluster0.fq0w9rc.mongodb.net/", tlsAllowInvalidCertificates = True)  # not a good idea to include id and password in code files
